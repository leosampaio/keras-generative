...
class ALICEforSVHN(ALICE):
    ...
    def build_D_cycle(self):
        ...
        x_hat = BasicConvLayer(128, (4, 4), strides=(1, 1), bnorm=True, dropout=0.2, activation='leaky_relu', leaky_relu_slope=0.01)(x_hat)
        x_hat = BasicConvLayer(256, (4, 4), strides=(2, 2), bnorm=True, dropout=0.2, activation='leaky_relu', leaky_relu_slope=0.01)(x_hat)
        x_hat = BasicConvLayer(512, (4, 4), strides=(1, 1), bnorm=True, dropout=0.2, activation='leaky_relu', leaky_relu_slope=0.01)(x_hat)
        x_hat = Flatten()(x_hat)

        x_x_hat = Concatenate(axis=-1)([x, x_hat])

        x_x_hat = Dense(1024)(x_x_hat)
