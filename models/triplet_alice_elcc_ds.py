...
class TripletALICEwithExplicitLCCandDS(BaseModel, metaclass=ABCMeta):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        kwargs['name'] = 'triplet_alice_elcc_ds'
    ...
    def build_trainer(self):
        ...
        d1_x_reconstructed = self.alice_d1.f_Gx(d1_z_hat)
        ...
        d2_x_reconstructed = self.alice_d2.f_Gx(d2_z_hat)
        ...
        return Model(
            input,
            [concatenated_d1, concatenated_d2, concatenated_lat_cycle_12, concatenated_lat_cycle_21, concatenated_triplet_enc],
            name='triplet_ali'
        )
    ...
    def build_model(self):
        ...
        self.gen_trainer.compile(optimizer=opt_g,
                                 ...
                                 loss_weights=[1., 1., 1., 1., self.triplet_weight])
